      ...
      <table class="table tabe-hover table-condensed" id="list">
        ...
        <tbody>
          <?php
					...
					$qry = $conn->query("SELECT t.*,concat(e.firstname,' ',e.lastname,' ',e.middlename) as name FROM task_list t inner join employee_list e on e.id = t.employee_id $where order by unix_timestamp(t.date_created) asc");
          ...
          <tr>
            ...
            <td class="text-center">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item view_task" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>">View
                  Task</a>
...
$(document).ready(function() {
  ...
  $('.manage_task').click(function() {
    uni_modal("<i class='fa fa-edit'></i> Edit Task", "manage_task.php?id=" + $(this).attr('data-id'),
      'mid-large')
  })
  ...
  $('.view_progress').click(function() {
    uni_modal("Progress for: " + $(this).attr('data-task'), "view_progress.php?id=" + $(this).attr('data-tid'),
      'mid-large')
  })
