        ...
        <div class="row">
          <div class="col-md-6 border-right">
            <div class="form-group">
              ...
              <input type="text" name="employee_id" class="form-control form-control-sm" required
            ...
            <div class="form-group">
              ...
              <select name="designation_id" id="designation_id" class="form-control form-control-sm select2">
                ...
                <?php 
								...
								?>
                <option value="<?php echo $row['id'] ?>"
                  <?php echo isset($designation_id) && $designation_id == $row['id'] ? 'selected' : '' ?>>
            ...
            <div class="form-group">
              ...
              <select name="evaluator_id" id="evaluator_id" class="form-control form-control-sm select2">
                <option value=""></option>
                <?php 
								$evaluators = $conn->query("SELECT *,concat(firstname,' ',lastname,' ',middlename) as name FROM evaluator_list order by concat(firstname,' ',lastname,' ',middlename) asc");
								while($row=$evaluators->fetch_assoc()):
								?>
                <option value="<?php echo $row['id'] ?>"
                  <?php echo isset($evaluator_id) && $evaluator_id == $row['id'] ? 'selected' : '' ?>>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group d-flex justify-content-center align-items-center">
              <img src="<?php echo isset($avatar) ? 'assets/uploads/'.$avatar :'' ?>" alt="Avatar" id="cimg"
            ...
            <div class="form-group">
              ...
              <small id="msg"></small> <!-- Updated here -->
            </div>
            <div class="form-group">
