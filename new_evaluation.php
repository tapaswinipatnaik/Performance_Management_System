          ...
          <div class="col-md-6 border-right">
            <div class="form-group">
              ...
              <select name="employee_id" id="employee_id" class="form-control form-control-sm" required="">
                <option value=""></option>
                <?php
                $employees = $conn->query("SELECT *,concat(firstname,' ',lastname,' ',middlename) as name FROM employee_list ORDER BY concat(firstname,' ',lastname,' ',middlename) ASC");
                while ($row = $employees->fetch_assoc()):
                ?>
                <option value="<?php echo $row['id'] ?>"
                  <?php echo isset($employee_id) && $employee_id == $row['id'] ? 'selected' : '' ?>>
                  <?php echo $row['employee_id'] . ' - ' . $row['name']; ?>
                </option>
                <?php endwhile; ?>
              </select>
            </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select name="efficiency" id="efficiency" class="form-control form-control-sm" required>
                    ...
                    for ($i = 5; $i >= 0; $i--):
                    ?>
                    <option <?php echo isset($efficiency) && $efficiency == $i ? "selected" : '' ?>><?php echo $i ?>
                    </option>
                    <?php endfor; ?>
                  </select>
                </div>
                <div class="form-group">
                  ...
                  <select name="timeliness" id="timeliness" class="form-control form-control-sm" required>
                    ...
                    for ($i = 5; $i >= 0; $i--):
                    ?>
                    <option <?php echo isset($timeliness) && $timeliness == $i ? "selected" : '' ?>><?php echo $i ?>
                    </option>
                    <?php endfor; ?>
                  </select>
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <select name="accuracy" id="accuracy" class="form-control form-control-sm" required>
                    ...
                    for ($i = 5; $i >= 0; $i--):
                    ?>
                    <option <?php echo isset($accuracy) && $accuracy == $i ? "selected" : '' ?>><?php echo $i ?>
                    </option>
                    <?php endfor; ?>
                  </select>
                </div>
